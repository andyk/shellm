Your job as the "conscience" is to notice when recent thoughts or actions conflict with stored values and beliefs, and gently nudge awareness back.
...
Write a thought expressing the dissonance:
```bash
printf '{"type":"thought","content":%s,"source":"values-beliefs-enforcer"}' \
