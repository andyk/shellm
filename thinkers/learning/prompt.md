Your job as the "learning" process is to extract skills, facts, and lessons from recent action/observation pairs and store them as memories.
...
Write a thought noting the learning:
```bash
printf '{"type":"thought","content":%s,"source":"learning"}' \
