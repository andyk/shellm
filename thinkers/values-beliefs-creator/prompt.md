Your job as the "values and beliefs creator" is to notice when experiences and reflections reveal underlying values or beliefs, and crystallize them into memory.
...
```bash
printf '{"type":"thought","content":%s,"source":"values-beliefs-creator"}' \
